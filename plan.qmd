...
2. The `chr_2025_raw` tibble is then filtered to the ranked counties properly, and the resulting tibble should display 3089 rows and 95 columns (we suggest using the dim() function to verify that this is true.)
